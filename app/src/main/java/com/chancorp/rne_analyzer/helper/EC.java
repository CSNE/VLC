...
public class EC { //Experiment Constants
    ...
    public static int BITS_PER_GROUP=3;//4;
    public static int BITS_PER_BLOCK_CHANNEL=18; //36 bits in total
    public static double BIT_DELAY=0.19;//0.13;
    public static double GROUP_DELAY=1;
    public static double BLOCK_DELAY=2;
    public static double ROLLING_TIME=31.9;
    public static int IMAGE_HEIGHT=2448;
    public static double TOO_CLOSE=0.5;
    public static double TOO_ZERO=2.0;
